...
class PW_User_Query extends WP_User_Query {
	...
	function prepare_order_by($orderBy){
		$orderby = $this->query_vars['orderby'];
		...
		if($this->query_vars['orderby']!=null && $this->query_vars['orderby']!=''){
			...
			$orderby = str_replace("date", "$wpdb->wp_prefix"."users.user_registered", $orderby);	
			$orderby = str_replace("comment_points", "$wpdb->pw_prefix"."user_meta.comment_points", $orderby);	
			$orderby = str_replace("post_points", "$wpdb->pw_prefix"."user_meta.post_points", $orderby);	
	...
	function query() {
		...
		$qv =& $this->query_vars;
		echo "ddddddddddddddddddddd".$this->query_orderby;
		echo json_encode($this->query_vars);
