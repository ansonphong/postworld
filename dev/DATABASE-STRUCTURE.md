...
#### __cron_run_id__ : *string* (auto-increment)
- An incremented ID generated by MySQL of the cron task

#### __function_type__ : *string*
- The name of the function which generated the cron task
  - ie. `pw_cache_feed`

#### __process_id__ : *string* (optional)
...
#### __posts__ : *integer* (optional)
- The number of posts processed, if applicable

#### __query_args__ : *string* (JSON) (optional)
