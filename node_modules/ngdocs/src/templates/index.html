  ...
  <script type="text/javascript">
    ...
    (function() {
      var indexFile = (location.pathname.match(/\/(index[^\.]*\.html)/) || ['', ''])[1],
          ...
          production = true;// location.hostname === 'docs.angularjs.org',
          headEl = document.getElementsByTagName('head')[0],
          sync = true,
          angularVersion = '1.0.5';
...
<body>
      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <ul class="nav">
            ...
            <li ng-repeat="section in sections"></li>
            <li class="dropdown">
  ...
  <div id="subpage" ng-show="subpage" style="display: none">
    <div>
      ...
      <p>
        If you want to be able to access the documentation offline, click the
        button below. This will reload the current page and trigger background downloads of all the
        necessary files. The next time you load the docs, the browser will
