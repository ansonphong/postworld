...
angular.module('mgcrea.ngStrap.popover', ['mgcrea.ngStrap.tooltip'])
  ...
  .provider('$popover', function() {
    ...
    var templatePath = '/postworld/lib/angular-strap/templates/popover.tpl.html';
    var templateUrl = window.pwSiteGlobals.paths.plugins_url + templatePath;

    // Support HTTPS
    if( window.pw.globals.view['protocol'] == 'https' )
