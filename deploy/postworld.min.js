...
},reset_password_submit:function(args){$log.debug("pwData.reset_password_submit",args);var params={args:args};return this.wp_ajax("reset_password_submit",params)},post_share_report:function(args){$log.debug("pwData.post_share_report",args);var params={args:args};return this.wp_ajax("post_share_report",params)},user_share_report_outgoing:function(args){$log.debug("pwData.user_share_report_outgoing",args);var params={args:args};return this.wp_ajax("user_share_report_outgoing",params)}}});